                            ...
                            @forelse($users as $user)
                                <tr>
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('database-users.show', $user) }}" class="text-blue-600 hover:text-blue-900 mr-3">View</a>
                                        <a href="{{ route('database-users.edit', $user) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
