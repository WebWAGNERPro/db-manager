    ...
    <x-slot name="header">
        <div class="flex justify-between items-center">
            ...
            <div class="flex items-center gap-2">
                <a href="{{ route('database-users.edit', $databaseUser) }}" class="inline-flex items-center px-3 py-1.5 bg-indigo-600 border border-transparent rounded-lg font-semibold text-xs text-white hover:bg-indigo-500 transition">
                    Edit
                </a>
