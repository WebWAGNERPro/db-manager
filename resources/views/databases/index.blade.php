                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        <thead class="bg-gray-50">
                            <tr>
                                ...
                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Charset</th>
                            ...
                            @forelse($databases as $database)
                                <tr>
                                    <td class="px-6 py-4 whitespace-nowrap">
                                        <a href="{{ route('databases.show', $database) }}" class="text-green-600 hover:text-green-800 font-medium">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                                        <a href="{{ route('databases.show', $database) }}" class="text-green-600 hover:text-green-900 mr-3">View</a>
                                        <a href="{{ route('databases.edit', $database) }}" class="text-indigo-600 hover:text-indigo-900 mr-3">Edit</a>
